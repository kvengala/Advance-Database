...
printf("\n its here after test after open \n");
  // insert keys
  for(i = 0; i < numInserts; i++)
    TEST_CHECK(insertKey(tree, keys[i], insert[i]));

printf("\n its here after test after insetr \n");
...
printf("\n its here after test after check stts \n");
  // search for keys
  for(i = 0; i < 1000; i++)
    {
...
printf("\n its here after test after search keysn");
  // cleanup
